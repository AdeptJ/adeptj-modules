 ...
 */
@Component(immediate = true, ds = false, metatype = true, configurationFactory = true, name = CacheProviderImpl.SERVICE_PID, 
...
public class CacheProviderImpl implements CacheProvider, ManagedServiceFactory {
	...
	public CacheProviderImpl(CacheManager cacheMgr) {
