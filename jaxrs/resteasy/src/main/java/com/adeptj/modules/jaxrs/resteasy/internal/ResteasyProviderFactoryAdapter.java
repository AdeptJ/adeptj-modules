 ...
 * provider instances as per the {@link #providerSkipList} array.
 * <p>
...
public class ResteasyProviderFactoryAdapter extends ResteasyProviderFactoryImpl {
    ...
    private final String[] providerSkipList;

    ResteasyProviderFactoryAdapter(String[] providerSkipList) {
        this.providerSkipList = providerSkipList;
    }

    @Override
    public void registerProvider(@NotNull Class provider,
                                 Integer priorityOverride, boolean isBuiltin, Map<Class<?>, Integer> contracts) {
        if (ArrayUtils.contains(this.providerSkipList, provider.getName())) {
