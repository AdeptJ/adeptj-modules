...
public class EntityManagerFactoryLifecycle {
    ...
    public EntityManagerFactoryLifecycle(@Reference DataSourceService dataSourceService,
                                         ...
                                         @NonNull @Reference PersistenceInfoProvider provider,
                                         @NonNull EntityManagerFactoryConfig config) {
    ...
    @Deactivate
    protected void stop(@NonNull EntityManagerFactoryConfig config) {
